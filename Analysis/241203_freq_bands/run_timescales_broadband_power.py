"""
Script for computing timescales and logging analysis parameters.
"""
...
# Output folder
out_dir = "timescales_power_broadband"
...
config_path = Path(__file__).parent.joinpath("configs_broadband.yml")
